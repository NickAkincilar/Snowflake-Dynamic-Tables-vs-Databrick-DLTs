...
This folder defines all source code for the 'TPCH_DLT_Test_' pipeline:
...
* Take a look at the sample under "sample_users_tpch_dlt_test.sql" to get familiar with the syntax.
